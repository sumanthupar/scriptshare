...
def process_page_to_csv(json_data, csv_file):
    """
    Processes JSON violation data and appends it to a CSV file.
...
def get_xray_watch_violations(server_base_url, access_token, watch_name):
    ...
    for i in range(total_pages):
        ...
        array_length = process_page_to_csv(page_data, csv_file)
    ...
    print(f"Successfully fetched a total of {violations_count} violations.")
    print(f"Final enriched CSV report created: {FINAL_OUTPUT_FILE}")
